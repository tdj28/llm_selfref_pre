...
| `data/sae_jlens_audit/confirmatory_v2_plan_20260712/` | Final result-free Stage 1 plan: exact 18 A1 and six A2 comparator assignments, 4,029 forward passes, five prompt folds, 14 readers, five stored random projections, residual schema, semantic and replay analysis plans, bound source/calibration hashes, private OSF project record, manifest SHA-256 `76bb17d63048093af9984006e6b25a49690151fd4fe37bcbbc450446aeacc466`, and a passing independent reconstruction. It contains no Stage 1 outcome and does not itself authorize execution; accepted public OSF registration is also required. |
